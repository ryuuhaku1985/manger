package com.jdxl.common.result;
...
public class ErrorResult extends BaseResult {
    ...
    public static ErrorResult response() {
        return new ErrorResult(DefaultMsgInfo.DEFAULT_SERVER_ERROR);
    }
    ...
    public static ErrorResult response(String msg) {
        return new ErrorResult(DefaultMsgInfo.CUSTOM_SERVER_ERROR, new String[]{msg});
    }
